module github.com/niqdev/gopher-labs

go 1.19

require (
	github.com/argoproj/argo-cd/v2 v2.7.5
...
replace (
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.26.3 // fixed manually
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.26.3 // fixed manually
